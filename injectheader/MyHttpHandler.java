...
class MyHttpHandler implements HttpHandler {
    ...
    public MyHttpHandler(MontoyaApi api, MyTableModel tableModel1) {
    ...
    public RequestToBeSentAction handleHttpRequestToBeSent(HttpRequestToBeSent requestToBeSent) {
        ...
        HttpRequest modifiedRequest = requestToBeSent.withAddedHeader(InjectHeaderExample.header_name,InjectHeaderExample.header_value);
